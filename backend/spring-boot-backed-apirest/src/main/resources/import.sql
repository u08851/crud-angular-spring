...
insert into usuarios (username, password, enabled,nombre,apellido,email) values ('andres','$2a$10$mV5oJvNJxeLuYK135A9Bcu4jOS1RkV/fc6XlomMeup87DhMzyiqCu',1,'Andres','Gusman','gusman@gmail.com');
insert into usuarios (username, password, enabled,nombre,apellido,email) values ('admin','$2a$10$pB1o6IKk1Mom/WIvXSWkiewRaaLXzHT6DvmdJoe/QHtAPvrlZaUqW',1,'Jhon','Jhnon','Jhon@gmail.com');
